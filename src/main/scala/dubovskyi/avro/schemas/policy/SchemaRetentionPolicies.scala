...
package dubovskyi.avro.schemas.policy

/**
  * This object contains options for schema retention during Avro/Spark conversions.
  *
  * When [[dubovskyi.avro.schemas.policy.SchemaRetentionPolicies.RETAIN_SELECTED_COLUMN_ONLY]] is used, the column
  * containing Avro data is extracted and the whole Dataframe schema becomes the Avro schema defining those data.
  *
  * When [[dubovskyi.avro.schemas.policy.SchemaRetentionPolicies.RETAIN_ORIGINAL_SCHEMA]] is used, the current
