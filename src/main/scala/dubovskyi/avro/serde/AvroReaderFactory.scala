...
package dubovskyi.avro.serde

import org.apache.avro.Schema
import dubovskyi.avro.format.ScalaAvroRecord
import dubovskyi.avro.parsing.utils.AvroSchemaUtils
import dubovskyi.avro.read.ScalaDatumReader
import dubovskyi.avro.read.confluent.{ScalaConfluentKafkaAvroDeserializer, SchemaManager}
